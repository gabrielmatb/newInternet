...
<body>
    ...
    <form action="{{ route('registrar_cliente') }}" method="POST">
        ...
        <div class="input-field col s8">
            ...
            <input type="text" name="rg" minlenght="9" maxlenght="9" required> <br />
        </div>
        <div class="input-field col s8">
            <label for="">CPF</label> <br />
            <input type="text" name="cpf" minlenght="11" maxlenght="11" required> <br />
        </div>
        <div class="input-field col s8">
            <label for="">Email</label> <br />
            <input type="email" name="email" minlenght="1" maxlenght="255" required> <br />
        </div>
        <div class="input-field col s8">
            <label for="">Telefone</label> <br />
            <input type="text" name="telefone" minlenght="11" maxlenght="11" required> <br />
        </div>
