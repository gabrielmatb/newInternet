...
@section('content')
    @if ((Route::has('home')) || (Route::has('homeError')) || (Route::has('listar_compra')) || (Route::has('listar_produto')))
    @auth
    <div class="container">
        <div class="row justify-content-center">
            <h1>Listagem dos Clientes:</h1>
            <a href="{{ route('criar_cliente') }}"><svg width="5em" height="5em" viewBox="0 0 16 16" class="bi bi-align-middle" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path d="M6 13a1 1 0 0 0 1 1h2a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1v10zM1 8a.5.5 0 0 0 .5.5H6v-1H1.5A.5.5 0 0 0 1 8zm14 0a.5.5 0 0 1-.5.5H10v-1h4.5a.5.5 0 0 1 .5.5z"/>
            </svg></a>
            <!--<a class="btn-floating btn-large waves-effect blue darken-4" href="{{ route('criar_cliente') }}"><i class="material-icons">add_circle</i></a>-->
                ...
                <tbody>
                    @foreach ( $clientes as $cliente )
                        <tr>
                            ...
                            <td><a href="{{ route('alterar_cliente', ['id' => $cliente->id]) }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-brush-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <td><a href="{{ route('excluir_cliente', ['id' => $cliente->id]) }}"><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-dash-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <!--<td><a class="btn-floating btn-small waves-effect waves-light orange" href="{{ route('alterar_cliente', ['id' => $cliente->id]) }}">
                                    <i class="material-icons">mode_edit</i></a></td>-->
                            <!--<td><a class="btn-floating btn-small waves-effect waves-light red" href="{{ route('excluir_cliente', ['id' => $cliente->id]) }}">
